...
class UserSettings(Base):
    ...
    # Custom wallpaper stored as a base64 data URL or a hosted image URL.
    # NULL means no custom wallpaper (use the default theme video).
    custom_wallpaper: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    ...
    # Stored as JSON text: [{"id":"...","name":"...","links":[...]}]
    # NULL means the frontend will use its own built-in defaults.
    music_groups: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
